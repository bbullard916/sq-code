...
public static class GameActionsData
{
    ...
    public class GameAction
    {
        ...
        public int Amount;
        public int Amount2;
        public string CustomeSaveTypeKey = ""; // KEY
        public int CustomeSaveTypeValue = 0; // 0 = int 1   1 = string 2 =   bool
        public int CustomeSaveType;
