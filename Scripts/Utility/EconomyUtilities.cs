    ...
    public static void GenerateDroppedLoot(RPGNpc npc, CombatEntity entity)
        {
            ...
            if (lootTable.UseRequirementsTemplate)
            {
            ...
            if (lootTable.Requirements != null && !RequirementsManager.Instance.RequirementsMet(GameState.playerEntity, lootTable.Requirements).Result) continue;
            //if(lootTable.RequirementsTemplate != null && RequirementsManager.Instance.RequirementsMet(GameState.playerEntity, lootTable.RequirementsTemplate.Requirements).Result == false) break;
