...
namespace BLINK.RPGBuilder.Templates
{
    public class NPCPresetTemplate : RPGBuilderDatabaseEntry
    {
        ...
        public float NavmeshAgentRadius = 0.5f, NavmeshAgentHeight = 2f, NavmeshAgentAngularSpeed = 500, NavmeshAgentOffset = 0f;
        ...
        public void UpdateEntryData(NPCPresetTemplate newEntryData)
        {
            ...
            NavmeshAgentOffset = newEntryData.NavmeshAgentOffset;
