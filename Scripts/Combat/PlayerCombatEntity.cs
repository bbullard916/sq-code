...
namespace BLINK.RPGBuilder.Combat
{
    ...
    public class PlayerCombatEntity : CombatEntity
    {
        ...
        private ScreenSpaceNameplates screenNameplates;
        private bool isCombatMusic;
        ...
        protected override void Start()
        {
            ...
            screenNameplates = GameObject.Find("UnitNameplates").GetComponent<ScreenSpaceNameplates>();
        }
        ...
        public void ResetTargetNameplate()
        {
            UIEvents.Instance.OnResetNameplate(CurrentTarget); // Removes CurrentTarget from the nameplate pool
            CurrentTarget = null;
        ...
        public override void ResetCombat()
        {
            ...
            if (isCombatMusic)
            {
                MusicManager.Instance.HandleNextMusic();
                isCombatMusic = false;
            }
        ...
        public override void EnterCombat()
        {
            ...
            if (!isCombatMusic)
            {
                ...
                MusicManager.Instance.enableCombatMusic();
                isCombatMusic = true;
            }
        }
        ...
        public override void SetTarget(CombatEntity entity)
        {
            ...
            // Condition for checking if the entity exists in the nameplate pool
            // screenNameplates is a reference to the object ScreenSpaceNameplates
            if (entity.GetNPCData().isNameplateEnabled && screenNameplates.AllNameplates
                .FirstOrDefault(s => s.Entity == entity) == null)
                UIEvents.Instance.OnRegisterNameplate(entity); // Adds the entity to the nameplate pool
