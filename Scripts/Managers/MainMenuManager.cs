...
namespace BLINK.RPGBuilder.Managers
{
    public class MainMenuManager : MonoBehaviour
    {
        ...
        public UISwitchSelect SwitchSelectHairChoices;
        public string CurrentSelectedhair;
        public string CurrentSelectedFacehair;
        public string CurrentHairColor;
        public string CurrentSkinColor;
        public Animator PlayerAnimator;
        public SetPlayerCustomization SetPlayerCustomization;
        private IEnumerator Start()
        {
            ...
            CustomDataProvider.Instance.LoadData();
        ...
        public void HandleHairColorSelection(Toggle hairColorToggle)
        {
            if (!hairColorToggle.isOn) return; // Only proceed if the toggle is on

            SetPlayerCustomization playerCustomization = GameObject.FindGameObjectWithTag("Player").GetComponent<SetPlayerCustomization>();
            if (playerCustomization == null)
            {
                Debug.LogError("SetPlayerCustomization component not found on Player object.");
                return;
            }

            string toggleName = hairColorToggle.gameObject.name;
            string hexColor = toggleName switch
            {
                "Haircolor0" => "FFE100FF",
                "Haircolor1" => "6C3E00FF",
                "Haircolor2" => "E24D1DFF",
            ...
            {
                playerCustomization.HairColor = HexToColor(hexColor);
                playerCustomization.SetHairColor(HexToColor(hexColor));
                CurrentHairColor = hexColor;
            }
            else
            {
                Debug.LogError("Invalid hair color toggle name: " + toggleName);
            }
        }
        public void HandleSkinColorSelection(Toggle skinColorToggle)
        {
            if (!skinColorToggle.isOn) return; // Only proceed if the toggle is on
            ...
            string toggleName = skinColorToggle.gameObject.name;
            string hexColor = toggleName switch
            {
                "Skin0" => "FFE396FF",
                "Skin1" => "714E1FFF",
            ...
            if (!string.IsNullOrEmpty(hexColor))
            {
                playerCustomization.SkinColor = HexToColor(hexColor);
                playerCustomization.SetSkinColor(HexToColor(hexColor));
        ...
        public void HandleFacialHairSelection(GameObject HairChoice)
        {
            //CustomDataProvider.Instance.SaveStringData("Hair", CurrentSelectedhair, HairChoice.GetComponent<UISwitchSelect>().m_SelectedItem);
            SetPlayerCustomization = GameObject.FindGameObjectWithTag("Player").GetComponent<SetPlayerCustomization>();
            string SelectedHair = HairChoice.GetComponent<UISwitchSelect>().m_SelectedItem;
            if (SelectedHair == "Hair0")
            {
                SetPlayerCustomization.SetFaceHair("FaceHair0");
                CurrentSelectedFacehair = "FaceHair0";
            }
            else if (SelectedHair == "Hair1")
            {
                SetPlayerCustomization.SetFaceHair("FaceHair1");
                CurrentSelectedFacehair = "FaceHair1";
            }
            else if (SelectedHair == "Hair2")
            {
                SetPlayerCustomization.SetFaceHair("FaceHair2");
                CurrentSelectedFacehair = "FaceHair2";
            }
            else if (SelectedHair == "Hair3")
            {
                SetPlayerCustomization.SetFaceHair("FaceHair3");
                CurrentSelectedFacehair = "FaceHair3";
            }
            else if (SelectedHair == "Hair4")
            {
                SetPlayerCustomization.SetFaceHair("FaceHair4");
                CurrentSelectedFacehair = "FaceHair4";
            }
            else if (SelectedHair == "Hair5")
            {
                SetPlayerCustomization.SetFaceHair("FaceHair5");
                CurrentSelectedFacehair = "FaceHair5";
            }
            else if (SelectedHair == "Hair6")
            {
                SetPlayerCustomization.SetFaceHair("FaceHair6");
                CurrentSelectedFacehair = "FaceHair6";
            }
            SetPlayerCustomization playerCustomization = GameObject.FindGameObjectWithTag("Player").GetComponent<SetPlayerCustomization>();
            playerCustomization.SetHairColor(playerCustomization.HairColor);
        }

        public void HandleHairChoiceSelection(GameObject HairChoice)
        {
            //CustomDataProvider.Instance.SaveStringData("Hair", CurrentSelectedhair, HairChoice.GetComponent<UISwitchSelect>().m_SelectedItem);
            SetPlayerCustomization = GameObject.FindGameObjectWithTag("Player").GetComponent<SetPlayerCustomization>();
            Debug.Log(HairChoice.GetComponent<UISwitchSelect>().m_SelectedItem);
            string SelectedHair = HairChoice.GetComponent<UISwitchSelect>().m_SelectedItem;
            if (SelectedHair == "Bald")
            {
                SetPlayerCustomization.SetHair("Hair0");
                CurrentSelectedhair = "Hair0";
            }
            else if (SelectedHair == "Long")
            {
                SetPlayerCustomization.SetHair("Hair1");
                CurrentSelectedhair = "Hair1";
            }
            else if (SelectedHair == "Short Straight")
            {
                SetPlayerCustomization.SetHair("Hair2");
                CurrentSelectedhair = "Hair2";
            }
            else if (SelectedHair == "Short Thick")
            {
                SetPlayerCustomization.SetHair("Hair3");
                CurrentSelectedhair = "Hair3";
            }
            SetPlayerCustomization playerCustomization = GameObject.FindGameObjectWithTag("Player").GetComponent<SetPlayerCustomization>();
            playerCustomization.SetHairColor(playerCustomization.HairColor);
        }
        ...
        public void SelectClass(int classIndex)
        {
            ...
            InitStatAllocation();
            PlayerAnimator = MainMenuManager.Instance.curPlayerModel.GetComponent<Animator>();
            PlayerAnimator = curPlayerModel.GetComponent<Animator>();
            if (classIndex == 0)
            {
            ...
            {
                PlayerAnimator.SetBool("warriorIdle", false);
                PlayerAnimator.SetBool("wizardIdle", true);
            }
        }
        ...
        public void CreateCharacter()
        {
            ...
            CustomDataProvider.Instance.ResetSaves(Character.Instance.CharacterData.CharacterName);
            RPGBuilderJsonSaver.GenerateCharacterEquippedtemsData();
            RPGBuilderJsonSaver.SaveCharacterData();
            CustomDataProvider.Instance.SaveStringData("Hair", CurrentSelectedhair, Character.Instance.CharacterData.CharacterName);
            CustomDataProvider.Instance.SaveStringData("HairColor", CurrentHairColor, Character.Instance.CharacterData.CharacterName);
            CustomDataProvider.Instance.SaveStringData("FacialHair", CurrentSelectedFacehair, Character.Instance.CharacterData.CharacterName);
            CustomDataProvider.Instance.SaveStringData("SkinColor", CurrentSkinColor, Character.Instance.CharacterData.CharacterName);
        ...
        public void SelectCharacter(string characterName)
        {
            ...
            PlayerAnimator = curPlayerModel.GetComponent<Animator>();
            PlayerAnimator.SetBool("warriorPose", true); PlayerAnimator = curPlayerModel.GetComponent<Animator>();
            PlayerAnimator.SetBool("warriorPose", true);
            curPlayerModel.transform.SetParent(characterModelSpot);
            curPlayerModel.transform.localPosition = Vector3.zero;
            curPlayerModel.transform.localRotation = Quaternion.identity;
            ...
            ES3Settings.defaultSettings.path = Character.Instance.CharacterData.CharacterName;
            CustomDataProvider.Instance.LoadData();
        }
