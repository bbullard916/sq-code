...
{
    public class CustomLootItemSlotHolder : MonoBehaviour, IPointerClickHandler, IDragHandler, IEndDragHandler, IBeginDragHandler,
        IDropHandler
    {
        public Image itemIcon, background;
        public TextMeshProUGUI itemStackText, itemNameText, ITemDescription;
        ...
        public void Init(int lootIndex, LootBag bag)
        {
            ...
            ITemDescription.text = holder.lootData[thisLootIndex].item.description;
        }
